...
public static class HeavyEquipmentAdDtoMapper
{
    ...
    // Maps HeavyEquipment entity to HeavyEquipmentAdDto - Used by: AdService.GetAdByIdAsync
    public static HeavyEquipmentAdDto MapToDto(Domain.Entities.Ads.Vehicles.HeavyEquipment.HeavyEquipment entity)
    {
